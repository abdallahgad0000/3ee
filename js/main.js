...
jQuery(document).on('ready', function() {
    ...
    var _tg_bestsellingbooksslider = jQuery('#tg-bestsellingbooksslider2');
    _tg_bestsellingbooksslider.owlCarousel({
        nav: true,
        loop: true,
        margin: 30,
    ...
    /*--------------------------------------
    		PICKED BY AUTHOR SLIDER			
    --------------------------------------*/
    var _tg_pickedVideos = jQuery('#tg-pickedVideos');
    _tg_pickedVideos.owlCarousel({
        nav: true,
        loop: true,
        dots: true,
        navText: [
...
setTimeout(() => {
    // console.log($(".icon-chevron-left"))
    // $(".icon-chevron-left").removeClass("icon-chevron-left")
    $(".icon-chevron-left").addClass("fas")
    $(".icon-chevron-left").addClass("fa-chevron-left")
    $(".icon-chevron-right").addClass("fas")
    $(".icon-chevron-right").addClass("fa-chevron-right")
}, 10);
